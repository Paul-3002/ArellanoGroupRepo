        ...
        <div class="page-content--bgf7">
            ...
            <div style="margin-top: 2%" class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Passenger</li>
                                    </ul>
                                </div>
            ...
            <div class="main-div">
        <h1 style="text-align: center; margin-top: 3%; margin-bottom: 3%">PASSENGER</h1>
                    ...
                    <tbody>
                        <?php
                            ...
                            ?>
                                ...
                                <td><i class='fas fa-trash' style='font-size:20px'></i></td>
