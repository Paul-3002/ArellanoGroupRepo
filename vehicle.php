        ...
        <div class="page-content--bgf7">
            ...
            <div style="margin-top: 2%" class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Vehicle</li>
                                    </ul>
                                </div>
            ...
            <div class="main-div">
        <h1 style="text-align: center; margin-top: 3%; margin-bottom: 3%">Vehicle</h1>
                    ...
                    <tbody>
                        <?php
                            ...
                            ?>
                                ...
                                <td> <?php echo $res['No._of_seats']; ?></td>
                                <td> <?php echo $res['Color']; ?></td>
                                <td> <span class="email-style"><?php echo $res['Plate_number']; ?></span></td>
                                </tr>
                            <?php
                            }
                            ?>
