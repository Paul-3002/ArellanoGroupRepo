...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-content--bgf7">
            ...
            <div class="main-div">
        <h1 style="text-align: center; margin-top: 3%; margin-bottom: 3%">Transactions</h1>
                ...
                <table>
                    ...
                    <tbody>
                        <?php
                            ...
                            ?>
                                <tr>
                                <td> <?php echo $res['transactid']; ?></td>
                                <td> <?php echo $res['Passenger_id']; ?></td>
                                <td> <?php echo $res['Driver_id']; ?></td>
                                <td> <?php echo $res['transactdate']; ?></td>
                                <td> <?php echo $res['pickup']; ?></td>
                                <td> <?php echo $res['drop_off']; ?></td>
                                <td> <?php echo $res['status']; ?></td>
                                <td><a href="location.php"><i class='fas fa-map-marked-alt' style='font-size:20px'></a></button></td>
                                </tr>
                            <?php
                            }
                            ?>
